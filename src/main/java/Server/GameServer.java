    ...
    class ServerThread extends Thread {
        ...
        public void run() {
            try {
                ...
                callback.accept("Server is running on: " + port);
                callback.accept("Waiting for client to connect to server...");
        ...
        public void run() {
            ...
            while (!this.connection.isClosed()) {
                try {
                    ...
                    callback.accept("Client #" + this.id + " sent a new request to the server: ");
                    ...
                    // condition to check if for new card if draw
                    ...
                    res.bankerHand = game.changeCardToStr(game.getBankerHand());
                    res.playerHand = game.changeCardToStr(game.getPlayerHand());
